...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../css/mysent.css">
	</head>
	<body>
		<div class="header">
			<div class="title1">
			    ...
			    <div class="left">
			    	<div class="leftcontent">
			    		<table class="table1">
			    			...
			    			<jsp:include page="mysent11.jsp"/>

<!-- 这里是已接受任务！！！！！循环下面的tr，动态判断状态：已接受、已完成 -->

			    			<jsp:include page="mysent12.jsp"/>
							
							<jsp:include page="mysent13.jsp"/>
			    	...
			    	<div class="rightcontent">
			    		<table class="table2">
			    			...
			    			<jsp:include page="mysent21.jsp"/>
			    			<jsp:include page="mysent22.jsp"/>
			    			<jsp:include page="mysent23.jsp"/>
		...
		<script src="../js/mysent.js"></script>
	</body>
</html>