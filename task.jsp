<%@ page contentType="text/html;charset=UTF-8" import="java.sql.*,com.leifeng.bean.*" 
import="java.util.*"%>
<html>
	<head>
		<title>任务大厅</title>
	...
	<%
		request.setAttribute("messageKd", request.getAttribute("messageKd"));
		request.setAttribute("messageSc", request.getAttribute("messageSc"));
	 %>
	<body>
		<div class="header">
			<div class="title1">
			...
			<div class="title2">
					...
					<div class="renwudating" ><a href="" ><div class="renwufont" style="background-color:#f32f2f;color:white;" id="renwudatingyanse" onmouseout="change26()" onmouseover="change27()"><p class="renwu">任务大厅</p></div></a></div>
					...
					<div class="wodeshouye"><a href="" ><div class="shouyefont" onmouseover="change19()" onmouseout="change20()" id="wodeshouyeyanse"><p class="shouye" >我的首页</p></div></a></div>
